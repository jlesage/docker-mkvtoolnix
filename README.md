...
This project provides a Docker container for [MKVToolNix](https://mkvtoolnix.download).
...
> [!NOTE]
> This Docker container is entirely unofficial and not made by the creators of MKVToolNix.
...
[Releases]: https://github.com/jlesage/docker-mkvtoolnix/releases
[Docker Hub]: https://hub.docker.com/r/jlesage/mkvtoolnix/tags
...
container, it would proxy all HTTP requests for `mkvtoolnix.domain.tld` to
...
| **Application version** label | Displays the version of MKVToolNix integrated into Docker image. |
...
Any desktop notification generated by MKVToolNix is forwarded to the
